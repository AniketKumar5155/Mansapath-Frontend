            ...
            >
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <nav className="space-x-8 hidden md:block">
                        <a href="#" className="hover:text-blue-600 cursor-pointer hover:font-bold">Home</a>
                        <a href="#services" className="hover:text-blue-600 cursor-pointer hover:font-bold">Services</a>
                        <a href="#about" className="hover:text-blue-600 cursor-pointer hover:font-bold">About</a>
                        <a href="#contact" className="hover:text-blue-600 cursor-pointer hover:font-bold">Contact</a>
                    </nav>

                    <div className="flex items-center gap-4">
                        <button
                            onClick={toggleDark}
                            className={`p-2 rounded-full transition hover:scale-110 cursor-pointer ${
                ...
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="mb-8 text-gray-500 leading-relaxed">
                            A safe, confidential, supportive space for your wellbeing.
                            We are here to guide you through each step of your journey.
                        </p>
                        ...
                        <div className="space-x-4">
                            ...
                            <button
                                className={`border px-6 py-3 rounded-2xl shadow transition cursor-pointer ${
                                    dark
                    ...
                    <div className="flex justify-center items-center">
                        <div
                            className={`h-64 md:h-80 rounded-2xl flex items-center justify-center ${
                                dark ? "bg-gray-800" : "bg-white"
                            }`}
                        >
                            <img
            ...
            >
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <p className="text-gray-500 mb-12 max-w-2xl mx-auto">
                        Our approach combines compassion, science and experience.
                    </p>

                    <div className="grid md:grid-cols-4 gap-8">
                        <Card dark={dark} icon={<Brain size={28} />} title="Expert Therapists" desc="Certified professionals with years of experience." />
                        <Card dark={dark} icon={<ShieldCheck size={28} />} title="Confidential & Safe" desc="Your privacy is our highest priority." />
                        <Card dark={dark} icon={<HeartPulse size={28} />} title="Personalized Care" desc="Custom plans for your mental wellbeing." />
                        <Card dark={dark} icon={<Users size={28} />} title="Supportive Community" desc="A network that understands and supports you." />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10">
                    <div>
                        ...
                        <p className="text-gray-500 mb-6">
                            If someone is struggling, reach out. We’re here for you.
                        </p>
                    ...
                    <div
                        className={`h-64 border-2 border-dashed rounded-2xl flex items-center justify-center ${
...
const OfferCard = ({ title, dark }) => (
    <motion.div
        ...
        className={`p-8 rounded-2xl shadow-md transition ${
            dark ? "bg-gray-800" : "bg-white"
        }`}
    >
        ...
        <div
            className={`mt-6 h-32 border-2 border-dashed rounded-xl flex items-center justify-center ${
                dark ? "bg-gray-900 border-gray-700" : "bg-gray-100 border-gray-300"
            }`}
        >
            Image to be added
        </div>
